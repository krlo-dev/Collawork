...
export function BottomNavBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex md:hidden justify-around items-center h-16 bg-surface-container-lowest border-t border-outline-variant">
      <Link
        href="/discover"
        className="flex flex-col items-center justify-center gap-1 text-primary font-bold w-full h-full"
      >
      ...
      <Link
        ...
        className="flex flex-col items-center justify-center gap-1 text-on-surface-variant w-full h-full"
      >
